...
use Milo\SaleBundle\Entity\Proveedor;
use Milo\SaleBundle\Form\ProveedorType;
...
class ProveedorController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MiloSaleBundle:Proveedor')->findAll();

        return $this->render('MiloSaleBundle:Proveedor:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('MiloSaleBundle:Proveedor:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MiloSaleBundle:Proveedor')->find($id);
        ...
        return $this->render('MiloSaleBundle:Proveedor:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('MiloSaleBundle:Proveedor:edit.html.twig', array(
            'entity'      => $entity,
