...
use Milo\SaleBundle\Entity\Producto;
use Milo\SaleBundle\Form\ProductoType;
...
class ProductoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MiloSaleBundle:Producto')->findAll();

        return $this->render('MiloSaleBundle:Producto:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('MiloSaleBundle:Producto:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MiloSaleBundle:Producto')->find($id);
        ...
        return $this->render('MiloSaleBundle:Producto:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('MiloSaleBundle:Producto:edit.html.twig', array(
            'entity'      => $entity,
